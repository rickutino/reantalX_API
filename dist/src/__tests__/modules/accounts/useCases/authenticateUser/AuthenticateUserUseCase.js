...
var AuthenticateUserUseCase_1 = require("@modules/accounts/authenticateUser/AuthenticateUserUseCase");
var CreateUserUseCase_1 = require("@modules/accounts/useCases/createUser/CreateUserUseCase");
var AppError_1 = require("@shared/errors/AppError");
var UsersRepositoryInMemory_1 = require("../../in-memory/UsersRepositoryInMemory");
...
describe("Authenticate User", function () {
    ...
    it("should not be able to authenticate with incorrect email", function () {
        expect(function () { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
