...
var DevolutionRentalUseCase = /** @class */ (function () {
    function DevolutionRentalUseCase(rentalRepository, carsRepository, dateProvider) {
    ...
    DevolutionRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var rental, car, total, minimum_daily, daily, dateNow, delay, calculate_fine;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.rentalRepository.findById(id)];
                    case 1:
                        rental = _b.sent();
                    ...
                    case 2:
                        ...
                        rental.total = total;
                        return [4 /*yield*/, this.rentalRepository.create(rental)];
                    case 3:
                        _b.sent();
